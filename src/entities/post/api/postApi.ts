...
import { Post, CreatePostRequest, Comment, CreateCommentRequest } from '../model/types'

export const postApi = {
  getTimeline: (params?: { offset?: number; limit?: number }): Promise<PaginatedResponse<Post>> =>
  ...
  getUserPosts: (userId: string, params?: { offset?: number; limit?: number }): Promise<PaginatedResponse<Post>> =>
  ...
  createComment: (postId: string, data: CreateCommentRequest): Promise<ApiResponse<Comment>> =>
